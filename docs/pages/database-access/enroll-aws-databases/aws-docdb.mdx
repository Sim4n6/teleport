...
![Teleport DocumentDB Access Self-Hosted](../../../img/database-access/guides/docdb_selfhosted.svg)
</TabItem>
<TabItem scope={["cloud"]} label="Teleport Enterprise Cloud">
![Teleport DocumentDB Cloud](../../../img/database-access/guides/docdb_cloud.svg)
</TabItem>

</Tabs>

(!docs/pages/includes/database-access/how-it-works/aws-auto-discovery.mdx db="Amazon DocumentDB cluster" !)
