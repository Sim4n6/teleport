...
type SSMInstallationResult struct {
	...
	// DiscoveryConfig is the name of the DiscoveryConfig that generated this SSM Run.
	// Is empty for matchers defined statically in discovery_service.
...
func invalidSSMInstanceResult(req SSMRunRequest, instanceID, instanceName, status string) *SSMInstallationResult {
	return &SSMInstallationResult{
		...
		DiscoveryConfig: req.DiscoveryConfigName,
