...
func (n *NotificationCommand) Initialize(app *kingpin.Application, _ *servicecfg.Config) {
	...
	n.ls = notif.Command("ls", "List notifications which were manually created using `tctl notifications create`. By default, this will list notifications capable of targetting multiple users, such as role-based ones. To list notifications directed only at a specific user, use the --user flag. To include notifications generated by Teleport, use --all.")
