...
func TestNotificationCommmandCRUD(t *testing.T) {
	...
	buf, err := runNotificationsCommand(t, clt, []string{"create", "--user", auditorUsername, "--title", "auditor user specific test notification", "--content", "This is a test notification."})
	...
	buf, err = runNotificationsCommand(t, clt, []string{"create", "--user", managerUsername, "--title", "manager user specific test notification", "--content", "This is a test notification."})
	require.NoError(t, err)
