...
func (CredentialsFromKeyAndCertPath) IsActive(config providerData) (bool, string) {
	certPath := stringFromConfigOrEnv(config.CertPath, "TF_TELEPORT_CERT", "")
	keyPath := stringFromConfigOrEnv(config.KeyPath, "TF_TELEPORT_KEY", "")
...
func (CredentialsFromKeyAndCertPath) Credentials(ctx context.Context, config providerData) (client.Credentials, error) {
	certPath := stringFromConfigOrEnv(config.CertPath, "TF_TELEPORT_CERT", "")
	keyPath := stringFromConfigOrEnv(config.KeyPath, "TF_TELEPORT_KEY", "")
	caPath := stringFromConfigOrEnv(config.RootCaPath, "TF_TELEPORT_ROOT_CA", "")
...
func (CredentialsFromKeyAndCertBase64) IsActive(config providerData) (bool, string) {
	certBase64 := stringFromConfigOrEnv(config.CertBase64, "TF_TELEPORT_CERT_BASE64", "")
	keyBase64 := stringFromConfigOrEnv(config.KeyBase64, "TF_TELEPORT_KEY_BASE64", "")
...
func (CredentialsFromKeyAndCertBase64) Credentials(ctx context.Context, config providerData) (client.Credentials, error) {
	certBase64 := stringFromConfigOrEnv(config.CertBase64, "TF_TELEPORT_CERT_BASE64", "")
	keyBase64 := stringFromConfigOrEnv(config.KeyBase64, "TF_TELEPORT_KEY_BASE64", "")
	caBase64 := stringFromConfigOrEnv(config.RootCaBase64, "TF_TELEPORT_ROOT_CA_BASE64", "")
...
func (CredentialsFromIdentityFilePath) IsActive(config providerData) (bool, string) {
	identityFilePath := stringFromConfigOrEnv(config.IdentityFilePath, "TF_TELEPORT_IDENTITY_FILE_PATH", "")
...
func (CredentialsFromIdentityFileString) IsActive(config providerData) (bool, string) {
	identityFileString := stringFromConfigOrEnv(config.IdentityFile, "TF_TELEPORT_IDENTITY_FILE", "")
...
func (CredentialsFromIdentityFileBase64) IsActive(config providerData) (bool, string) {
	identityFileBase64 := stringFromConfigOrEnv(config.IdentityFileBase64, "TF_TELEPORT_IDENTITY_FILE_BASE64", "")
...
func (CredentialsFromProfile) IsActive(config providerData) (bool, string) {
	profileName := stringFromConfigOrEnv(config.ProfileName, "TF_TELEPORT_PROFILE_NAME", "")
	profileDir := stringFromConfigOrEnv(config.ProfileDir, "TF_TELEPORT_PROFILE_PATH", "")
